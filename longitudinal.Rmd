...
I had to fix two things to get this example to run properly in jags. First, I had to remove some lines of code that used functions like post.p.vale. Second, I have to transpose the matrix of data. But with these changes it ran just fine.
